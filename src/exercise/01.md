...
Then in the network tab we can see this chunk being prefetched together with the page start in 591ms. If we now hover over the checkbox, it is ready and visible within 5ms!
