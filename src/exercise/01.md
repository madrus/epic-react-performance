...
Also, we can force pre-loading even before the user clicks the button or checkbox by anticipating their action on mouse over (when using the mouse) or focus (when using the keyboard).
